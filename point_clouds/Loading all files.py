...
for filename in file_names[:3]:  # Adjust this slice as needed
    ...
    # Call the function and get the processed point cloud
    pcd = visualize_single_file(full_path)

    # Clear the previous point cloud from the visualizer
    vis.clear_geometries()

    # Add the new point cloud to the visualizer
