...
combined_df = pd.read_csv('Lidar Website/combined_df.csv')
smaller_by_100_df = pd.read_csv('Lidar Website/smaller_by_100_df.csv')
big_df = pd.read_csv('Lidar Website/big_df.csv')
df = combined_df
